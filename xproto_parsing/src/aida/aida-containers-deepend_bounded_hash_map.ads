...
package Aida.Containers.Deepend_Bounded_Hash_Map is
...
private
   ...
   type Number_Of_Stored_Elements_Array_Ptr is access all Number_Of_Stored_Elements_Array_T;
   ...
   type Bucket_Array_Ptr is access all Bucket_Array_T;

   type T is
      record
         Buckets                   : Bucket_Array_Ptr;
         Number_Of_Stored_Elements : Number_Of_Stored_Elements_Array_Ptr;
