...
package BC.Containers.Queues.Ordered.Bounded is
   ...
   type Unconstrained_Queue
     (Maximum_Size : Positive) is new Abstract_Ordered_Queue with private;
   ...
   --  Indicates number of empty "Item slots" left in the queue.
...
private
   ...
   type Unconstrained_Queue
     (Maximum_Size : Positive)
   is new Abstract_Ordered_Queue with record
