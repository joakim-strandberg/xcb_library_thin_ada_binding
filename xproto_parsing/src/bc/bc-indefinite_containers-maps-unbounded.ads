...
package BC.Indefinite_Containers.Maps.Unbounded is
...
private
   ...
   package KC is new BC.Support.Indefinite_Unbounded
     (Item => Key,
      "=" => Maps."=",
      Item_Ptr => Key_Ptr,
      Storage => Storage);
   ...
   package IC is new BC.Support.Indefinite_Unbounded
     (Item => Item,
...
end BC.Indefinite_Containers.Maps.Unbounded;
