...
package BC.Support.Indefinite_Bounded_Hash_Tables is
   ...
   package Tables is
      ...
      package Smart_Items
      is new BC.Support.Indefinite_Reference (T => Items.Item,
                                              "=" => Items.Eq,
                                              P => Items.Item_Ptr);
      package Smart_Values
      is new BC.Support.Indefinite_Reference (T => Values.Value,
                                              "=" => Values.Eq,
                                              P => Values.Value_Ptr);
      ...
      type Cell is record
         Item : Smart_Items.Pointer;
         Value : Smart_Values.Pointer;
         Next : Index;
      end record;
