...
--  $Revision: 1465 $
--  $Date: 2011-06-12 18:55:50 +0100 (Sun, 12 Jun 2011) $
--  $Author: simonjwright $

--  This package is the root of a tree of container packages that
--  support indefinite non-limited types (for example, String).
--
--  Storage for the container itself and for the contained elements is
--  managed internally.

generic
   type Item (<>) is private;
   with function "=" (L, R : Item) return Boolean is <>;
package BC.Indefinite_Unmanaged_Containers is
