...
package X_Proto_XML.Allocators is
   ...
   function New_Type is new Bounded_Dynamic_Pools.Allocation_Scoped_Subpool (Allocation_Type        => Type_P.T,
                                                                             Allocation_Type_Access => Type_P.Ptr);

   function New_Item is new Bounded_Dynamic_Pools.Allocation_Scoped_Subpool (Allocation_Type        => Item.T,
                                                                             Allocation_Type_Access => Item.Ptr);

   function New_Documentation is new Bounded_Dynamic_Pools.Allocation_Scoped_Subpool (Allocation_Type        => Documentation.T,
   ...
   function New_Operation is new Bounded_Dynamic_Pools.Allocation_Scoped_Subpool (Allocation_Type        => Operation.T,
